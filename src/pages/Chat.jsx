...
import { connectSocket, markRead, sendMessage, sendTyping } from "../services/socketService";
...
export default function Chat() {
  ...
  // useEffect(() => {
  //   console.log("selectedUserIsTypeing:", selectedUserIsTypeing);

  // }, [selectedUserIsTypeing])
  // // detect when user manually scrolls up
              ...
              <div>
                ...
                <p className="text-xs text-neutral-400">
                  {onlineUsers.has(selectedUser.id || selectedUser._id)
                    ? typingUsers.has(selectedUser.id || selectedUser._id) ? "💬 Typing..." : "🟢 Online"
                    : "🔴 Offline"}
                </p>
              </div>
            </div>
